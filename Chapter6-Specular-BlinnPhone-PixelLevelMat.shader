Shader "Unity Shaders Book/Chapter 6/Specular BlinnPhone PixelLevel" {
    Properties
    {
    ...
    SubShader 
    {
        Pass 
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                fixed3 viewDir = UnityWorldSpaceViewDir(i.worldPos);//fixed3 viewDir = normalize(_WorldSpaceCameraPos.xyz - i.worldPos.xyz);
